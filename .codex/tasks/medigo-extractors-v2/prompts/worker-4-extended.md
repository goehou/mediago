# worker-4 extended goal: 完成原 3 站 + 新增以下 wallstreets 站

## 你已经在做的 3 站 (继续完成)
按原计划提交.

## 新增任务清单 (按顺序做)
meeting minshi orangevip plaso qlchat renrenjiang sier speiyou tmooc unipus wallstreets
...
## 全部完成后
`git push -u origin work/v2-batch1-w4`
然后在 pane 里写 "DONE: 14 sites committed + audit report at .codex/audit/w4-reviewed-w?.md"

## 你的工作目录
/home/sophomores/code/medigo-w4 (branch work/v2-batch1-w4)
